/**
 * Rehber yazıları — organik trafiğin ana kaynağı.
 *
 * Yazılar özgün ve bilgi verici olacak şekilde yazılmıştır; rakip metin
 * kopyalanmaz. Yeni yazı eklerken: slug benzersiz olmalı, excerpt 150-160
 * karakteri geçmemeli (meta description olarak kullanılır).
 *
...
async function seedBlog() {
  ...
  console.log(`🎉 ${POSTS.length} yazı hazır.`);
  process.exit(0);
}
